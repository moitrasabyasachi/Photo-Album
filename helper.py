...
<PhotoGalleryScreen>:
    ...
    BoxLayout:
        ...
        MDToolbar:
            ...
            right_action_items: [["dots-vertical", lambda x: root.dropdown_menu()]]        
        BoxLayout:            
            orientation: "vertical" 
            ScrollView:
                MDGridLayout:
...
<ViewPhotoScreen>:
    ...
    BoxLayout:
        ...
        MDToolbar:
            id: toolbar                                     
            anchor_title: "center"
            left_action_items: [["arrow-left", lambda x: root.photo_gallery_screen()]]
            right_action_items: [["blank", lambda x: x]]                    
        BoxLayout:            
            orientation: "vertical" 
            ScrollView:
                id: scroll_view
